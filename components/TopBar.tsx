  ...
  return (
    <View style={styles.container}>
      <View className="flex-row items-center w-11/12">
        ...
        <View style={{ backgroundColor: buttonColor}} className="flex-initial max-w-32 h-12 items-center justify-center p-2 rounded-full ml-2">
          <Text style={{ color: themeColor, fontWeight: 'bold' }}>{user?.name}</Text>
        </View>
      </View>
